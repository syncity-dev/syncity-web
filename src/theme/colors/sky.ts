...
export const sky = defineSemanticTokens.colors({
  ...
  solid: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.sky.9}", _dark: "{colors.sky.9}" },
      },
      hover: {
    ...
    fg: {
      DEFAULT: {
        value: { _light: "{colors.slate.12}", _dark: "{colors.slate.1}" },
      },
    },
  },
  subtle: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.sky.a3}", _dark: "{colors.sky.a3}" },
      },
      hover: {
        value: { _light: "{colors.sky.a4}", _dark: "{colors.sky.a4}" },
      },
      active: {
        value: { _light: "{colors.sky.a5}", _dark: "{colors.sky.a5}" },
      },
    },
    fg: {
      DEFAULT: {
        value: { _light: "{colors.sky.a11}", _dark: "{colors.sky.a11}" },
      },
    },
  },
  surface: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.sky.a2}", _dark: "{colors.sky.a2}" },
      },
      active: {
        value: { _light: "{colors.sky.a3}", _dark: "{colors.sky.a3}" },
      },
    ...
    border: {
      DEFAULT: {
        value: { _light: "{colors.sky.a6}", _dark: "{colors.sky.a6}" },
      },
      hover: {
        value: { _light: "{colors.sky.a7}", _dark: "{colors.sky.a7}" },
      },
    },
    fg: {
      DEFAULT: {
