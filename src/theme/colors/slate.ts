...
export const slate = defineSemanticTokens.colors({
  ...
  subtle: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.slate.a3}", _dark: "{colors.slate.a3}" },
      },
      hover: {
        value: { _light: "{colors.slate.a4}", _dark: "{colors.slate.a4}" },
      },
      active: {
        value: { _light: "{colors.slate.a5}", _dark: "{colors.slate.a5}" },
      },
    },
    fg: {
      DEFAULT: {
  ...
  surface: {
    bg: {
      DEFAULT: {
        value: { _light: "{colors.white}", _dark: "{colors.slate.1}" },
      },
      hover: {
        value: { _light: "{colors.slate.2}", _dark: "{colors.slate.2}" },
      },
      active: {
        value: { _light: "{colors.slate.3}", _dark: "{colors.slate.3}" },
      },
    },
    border: {
      DEFAULT: {
      ...
      hover: {
        value: { _light: "{colors.slate.7}", _dark: "{colors.slate.7}" },
      },
    },
    fg: {
      DEFAULT: {
  ...
  outline: {
    bg: {
      hover: {
        value: { _light: "{colors.slate.a2}", _dark: "{colors.slate.a2}" },
      },
      active: {
        value: { _light: "{colors.slate.a3}", _dark: "{colors.slate.a3}" },
      },
