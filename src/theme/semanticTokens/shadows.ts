...
export const shadows = defineSemanticTokens.shadows({
  xs: {
    value: {
      _light: '0px 1px 2px {colors.gray.a4}, 0px 0px 1px {colors.gray.a5}',
  ...
  top: {
    value: {
      _light: '0px -2px 6px {colors.gray.a3}, 0px 0px 1px {colors.gray.a4}',
      _dark: '0px -2px 6px {colors.black.a6}, 0px 0px 1px inset {colors.gray.a8}',
    },
  },
});
