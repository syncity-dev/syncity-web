export const teamMembers = [
  {
    ...
    description:
      "Specializing in Flutter and Mobile Development, with a focus on team leadership.",
  ...
  },
  {
    ...
    description:
      "Building apps with JavaScript, TypeScript, React and other web technologies.",
