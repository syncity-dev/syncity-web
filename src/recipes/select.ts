  ...
  variants: {
    ...
    size: {
      ...
      sm: {
        ...
        trigger: { px: '2', py: '2', textStyle: 'sm', gap: '2', _icon: { boxSize: '4' } },
      },
      md: {
        ...
        trigger: { px: '3', py: '4', textStyle: 'md', gap: '2', _icon: { boxSize: '4' } },
      },
      lg: {
        content: { p: '1', gap: '0.5', textStyle: 'md' },
        ...
        trigger: { px: '4', py: '5', textStyle: 'md', gap: '2', _icon: { boxSize: '4.5' } },
      },
      xl: {
