    ...
    placement: {
      right: {
        content: {
          ...
          _open: { animation: 'slide-from-right-full 0.28s cubic-bezier(0.2, 0.8, 0.2, 1) both' },
          _closed: { animation: 'slide-to-right-full 0.28s cubic-bezier(0.2, 0.8, 0.2, 1) both' },
        },
      },
    },
  },
